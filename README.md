...
recent5 / recent10 
최근 10경기 성공률 구하기
day ex) 5월 5일 > 20200505
day가 바뀌니까 최근 5경기 구하는 함수 수정

vs + 날짜로 정렬해서 상대별 누적 타수, 누적 안타 구하기
이 데이터를 사용해서 vs 타율 쓰기
vs (두산 / @두산) 이용해서 vs팀, 구장 구하기
hit 이용해서 result 구하기 (성공 1 / 실패 0)
